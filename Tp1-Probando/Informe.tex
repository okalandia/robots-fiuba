...
\section{Preparandoo las corridas}
Se seleccion\'o la base de datos del Ta-Te-Ti, extra\'ida de la p\'agina UCI (Machine Learning Repository)

\subsection{Descripci\'on base de datos seleccionada}

\subsubsection{Informaci\'on relevante}
...
\begin{itemize}
 ...
 \item Distribución de Clase: Acerca de un 65,3\% son positivos (es decir, gana para "x").
\end{itemize}
